<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="index.php?page_layout=category"><svg class="glyph stroked clipboard with paper">
						<use xlink:href="#stroked-clipboard-with-paper" />
					</svg> Danh Mục</a></li>
			<li><a href="index.php?page_layout=product"><svg class="glyph stroked bag">
						<use xlink:href="#stroked-bag"></use>
					</svg> Sản phẩm</a></li>
			<li><a href="index.php?page_layout=order"><svg class="glyph stroked notepad ">
